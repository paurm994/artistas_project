"""
Django settings for artistas_project project.
...
SECRET_KEY = 'django-insecure-ovrscft4u8mm)eze$l2k+8pc8ti$a%f07&y#*p*1hyunr*_2ok'
...
MIDDLEWARE = [
    ...
    'artistas_project.middleware.LogPostMiddleware',
]

ROOT_URLCONF = 'artistas_project.urls'
...
WSGI_APPLICATION = 'artistas_project.wsgi.application'
